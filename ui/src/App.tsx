      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-[1200px] mx-auto px-6 h-10 flex items-center justify-between">
          ...
          <button
            ...
            title={
              hasPrev
                ? 'Save current data as the new baseline and reset counters'
                : 'Save current data as a baseline to compare against'
            }
      ...
      <main className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-3 flex flex-col gap-3">
        ...
        {hasPrev &&
          ...
          (() => {
            ...
            return (
              <div
                className={`rounded-lg px-4 h-9 flex items-center gap-3 border text-xs ${improved ? 'bg-emerald-50 border-emerald-200' : 'bg-red-50 border-red-200'}`}
              >
                <span>{improved ? '🎉' : '📈'}</span>
